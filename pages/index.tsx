...
const Pages = () => {
    ...
    useEffect(() => {
        ...
        setKeyword(localStorage.getItem("search_exclusion_keyword") || '')
    }, []);
    return (
        <>
            <div className='my-1 mx-6 w-80'>
                <div className="mt-2 mb-0.5"><h1 className="text-gray-200 text-lg font-extrabold">GitHub Searcher Extension</h1></div>
                ...
                <div>
                    <input
                        type='text'
                        placeholder='Exclusion Keyword ( -keyword )'
